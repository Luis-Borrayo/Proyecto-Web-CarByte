...
<body>
    ...
    <div class="contenedor-dashboard">
        ...
        <form method="get">
            ...
            <label for="">De:</label><input type="date" name="fecha_inicio" value="<?= htmlspecialchars($fecha_inicio) ?>">
            <label for="">Hasta:</label><input type="date" name="fecha_fin" value="<?= htmlspecialchars($fecha_fin) ?>">
